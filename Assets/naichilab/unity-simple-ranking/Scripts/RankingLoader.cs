...
namespace naichilab
{
	public class RankingLoader:MonoBehaviour
	{
		...
		public void SendScoreAndShowRanking (double score,double dis,double coin)
		{
            ...
            this.Distance = new NumberScore(dis, this.setting.CustomFormat);
            this.Coin = new NumberScore(coin, this.setting.CustomFormat);
