...
namespace naichilab
{
	public class RankingSceneManager : MonoBehaviour
	{
		...
		IEnumerator GetHighScoreAndRankingBoard ()
		{
            ...
            this.disLabel.text = RankingLoader.Instance.Distance.TextForDisplay;
            this.coinLabel.text = RankingLoader.Instance.Coin.TextForDisplay;
